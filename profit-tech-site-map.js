...
// global arrays
// ---------------------------------------------------
// تعريب و تطوير فن الربح 
// http://Profit-tech.blogspot.com
// Date : 25-06-2015
// ---------------------------------------------------
         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title="انقر هنا لفتح جميع موضوعات القسم \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTool1 = 'انقر للعرض حسب العنوان';
   var tocHead2 = 'تاريخ الموضوع';
   var tocTool2 = 'انقر للعرض حسب التاريح';
...
function showToc() {
  ...
  else { alert("انتظر من فضلك ..... حتى يتم تحميل الفهرس"); }
}
